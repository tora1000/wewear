...
ActiveRecord::Schema.define(version: 2021_01_09_093031) do
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "text"
    t.bigint "user_id"
    t.bigint "coordination_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["coordination_id"], name: "index_comments_on_coordination_id"
  ...
  add_foreign_key "comments", "coordinations"
